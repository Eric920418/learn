...
/* --- Events Section --- */
function EventsSection({ events }: { events: { id: string; date: string; titleCn: string; titleEn: string; speaker: string; speakerTitle: string; location: string; info: string | null; image: string | null; link: string | null }[] }) {
  return (
